  ...
  if (isset($_SESSION['user_id'])) {
	...
	if(isset($_POST["submit"])){
		if(!empty($_POST['mensaje'])){
			...
			$query = "INSERT INTO Foro_RB (ID_autor, titulo, mensaje, identificador, fecha, ult_respuesta, enlace) VALUES ('$ID_autor', '$titulo', '$mensaje', '$identificador','$fecha','$fecha','$Enlace')";
